...
document.addEventListener('DOMContentLoaded', function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    var client, room, e_1, pin, el, pinEl, queryCopyButton, copyButton;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, client.create("battle", { /* options */})];
            case 2:
                room = _a.sent();
            ...
            case 4:
                ...
                queryCopyButton = function () { return document.querySelector("#copy"); };
                copyButton = queryCopyButton();
